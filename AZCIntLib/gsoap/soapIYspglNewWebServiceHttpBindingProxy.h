/* soapIYspglNewWebServiceHttpBindingProxy.h
...
#ifndef soapIYspglNewWebServiceHttpBindingProxy_H
#define soapIYspglNewWebServiceHttpBindingProxy_H
#include "soapH.h"

class SOAP_CMAC IYspglNewWebServiceHttpBindingProxy : public soap
{ public:
	/// Endpoint URL of service 'IYspglNewWebServiceHttpBindingProxy' (change as needed)
	const char *soap_endpoint;
	/// Variables globally declared in IYspglNewWebService.h (non-static)
	/// Constructor
	IYspglNewWebServiceHttpBindingProxy();
	/// Construct from another engine state
	IYspglNewWebServiceHttpBindingProxy(const struct soap&);
	/// Constructor with endpoint URL
	IYspglNewWebServiceHttpBindingProxy(const char *url);
	/// Constructor with engine input+output mode control
	IYspglNewWebServiceHttpBindingProxy(soap_mode iomode);
	/// Constructor with URL and input+output mode control
	IYspglNewWebServiceHttpBindingProxy(const char *url, soap_mode iomode);
	/// Constructor with engine input and output mode control
	IYspglNewWebServiceHttpBindingProxy(soap_mode imode, soap_mode omode);
	/// Destructor frees deserialized data
	virtual	~IYspglNewWebServiceHttpBindingProxy();
	/// Initializer used by constructors
	virtual	void IYspglNewWebServiceHttpBindingProxy_init(soap_mode imode, soap_mode omode);
