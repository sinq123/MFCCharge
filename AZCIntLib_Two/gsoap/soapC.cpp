...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.21 2021-01-06 05:43:48 GMT")
...
void _ns1__queryObjectOut::soap_default(struct soap *soap)
{
	...
	this->_ns1__queryObjectOut::jylsh = NULL;
...
void _ns1__queryObjectOut::soap_serialize(struct soap *soap) const
{
	...
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__queryObjectOut::jylsh);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__queryObjectOut(struct soap *soap, const char *tag, int id, const _ns1__queryObjectOut *a, const char *type)
{
	...
	{	if (soap_out_PointerTostd__wstring(soap, "ns1:jkid", -1, &a->_ns1__queryObjectOut::jkid, ""))
		...
		return soap->error;
	if (a->_ns1__queryObjectOut::jylsh)
	{	if (soap_out_PointerTostd__wstring(soap, "ns1:jylsh", -1, &a->_ns1__queryObjectOut::jylsh, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "ns1:jylsh"))
		return soap->error;
...
SOAP_FMAC3 _ns1__queryObjectOut * SOAP_FMAC4 soap_in__ns1__queryObjectOut(struct soap *soap, const char *tag, _ns1__queryObjectOut *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_jylsh1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:jylsh", &(a->_ns1__queryObjectOut::jylsh), "xsd:string"))
				{	soap_flag_jylsh1--;
					continue;
				}
	...
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_xtlb1 > 0 || soap_flag_jkxlh1 > 0 || soap_flag_jkid1 > 0 || soap_flag_jylsh1 > 0 || soap_flag_cjbh1 > 0 || soap_flag_yhbz1 > 0 || soap_flag_dwmc1 > 0 || soap_flag_dwjgdm1 > 0 || soap_flag_yhxm1 > 0 || soap_flag_zdbs1 > 0 || soap_flag_queryXml1 > 0))
	{	soap->error = SOAP_OCCURS;
		return NULL;
	}
	return a;
...
void _ns1__writeObjectOut::soap_default(struct soap *soap)
{
	...
	this->_ns1__writeObjectOut::jylsh = NULL;
...
void _ns1__writeObjectOut::soap_serialize(struct soap *soap) const
{
	...
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__writeObjectOut::jylsh);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__writeObjectOut(struct soap *soap, const char *tag, int id, const _ns1__writeObjectOut *a, const char *type)
{
	...
	{	if (soap_out_PointerTostd__wstring(soap, "ns1:jkid", -1, &a->_ns1__writeObjectOut::jkid, ""))
		...
		return soap->error;
	if (a->_ns1__writeObjectOut::jylsh)
	{	if (soap_out_PointerTostd__wstring(soap, "ns1:jylsh", -1, &a->_ns1__writeObjectOut::jylsh, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "ns1:jylsh"))
		return soap->error;
...
SOAP_FMAC3 _ns1__writeObjectOut * SOAP_FMAC4 soap_in__ns1__writeObjectOut(struct soap *soap, const char *tag, _ns1__writeObjectOut *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_jylsh1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:jylsh", &(a->_ns1__writeObjectOut::jylsh), "xsd:string"))
				{	soap_flag_jylsh1--;
					continue;
				}
			if (soap_flag_cjbh1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
	...
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_xtlb1 > 0 || soap_flag_jkxlh1 > 0 || soap_flag_jkid1 > 0 || soap_flag_jylsh1 > 0 || soap_flag_cjbh1 > 0 || soap_flag_yhbz1 > 0 || soap_flag_dwmc1 > 0 || soap_flag_dwjgdm1 > 0 || soap_flag_yhxm1 > 0 || soap_flag_zdbs1 > 0 || soap_flag_writeXml1 > 0))
	{	soap->error = SOAP_OCCURS;
		return NULL;
	}
	return a;
