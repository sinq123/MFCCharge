...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.21 2021-01-03 07:52:11 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_PointerTo_ns1__VedioPlay:
		return soap_in_PointerTo_ns1__VedioPlay(soap, NULL, NULL, "ns1:VedioPlay");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		t = soap->tag;
		if (!soap_match_tag(soap, t, "ns1:VedioPlayResponse"))
		{	*type = SOAP_TYPE__ns1__VedioPlayResponse;
			return soap_in__ns1__VedioPlayResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns1:VedioPlay"))
		{	*type = SOAP_TYPE__ns1__VedioPlay;
			return soap_in__ns1__VedioPlay(soap, NULL, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE__ns1__VedioPlayResponse:
		return ((_ns1__VedioPlayResponse *)ptr)->soap_out(soap, "ns1:VedioPlayResponse", id, NULL);
	case SOAP_TYPE__ns1__VedioPlay:
		return ((_ns1__VedioPlay *)ptr)->soap_out(soap, "ns1:VedioPlay", id, NULL);
	...
	case SOAP_TYPE_PointerTo_ns1__VedioPlay:
		return soap_out_PointerTo_ns1__VedioPlay(soap, tag, id, (_ns1__VedioPlay *const*)ptr, "ns1:VedioPlay");
	case SOAP_TYPE_PointerTo_ns1__queryObjectOut:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_std__wstring:
		...
		break;
	case SOAP_TYPE__ns1__VedioPlayResponse:
		((_ns1__VedioPlayResponse *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE__ns1__VedioPlay:
		((_ns1__VedioPlay *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE__ns1__queryObjectOutResponse:
	...
	case SOAP_TYPE__ns1__writeObjectOut:
		...
		break;
	case SOAP_TYPE___ns1__VedioPlay_:
		soap_serialize___ns1__VedioPlay_(soap, (const struct __ns1__VedioPlay_ *)ptr);
		break;
	...
	case SOAP_TYPE___ns1__writeObjectOut_:
		...
		break;
	case SOAP_TYPE___ns1__VedioPlay:
		soap_serialize___ns1__VedioPlay(soap, (const struct __ns1__VedioPlay *)ptr);
		break;
	...
	case SOAP_TYPE___ns1__writeObjectOut:
		...
		break;
	case SOAP_TYPE_PointerTo_ns1__VedioPlay:
		soap_serialize_PointerTo_ns1__VedioPlay(soap, (_ns1__VedioPlay *const*)ptr);
		break;
	case SOAP_TYPE_PointerTo_ns1__queryObjectOut:
...
{	(void)type;
	...
	case SOAP_TYPE__ns1__VedioPlay:
		return (void*)soap_instantiate__ns1__VedioPlay(soap, -1, type, arrayType, n);
	case SOAP_TYPE__ns1__VedioPlayResponse:
		return (void*)soap_instantiate__ns1__VedioPlayResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__writeObjectOut:
	...
	case SOAP_TYPE___ns1__VedioPlay:
		return (void*)soap_instantiate___ns1__VedioPlay(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__writeObjectOut_:
	...
	case SOAP_TYPE___ns1__VedioPlay_:
		return (void*)soap_instantiate___ns1__VedioPlay_(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
{	switch (p->type)
	...
	case SOAP_TYPE__ns1__VedioPlay:
		if (p->size < 0)
			SOAP_DELETE((_ns1__VedioPlay*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__VedioPlay*)p->ptr);
		break;
	case SOAP_TYPE__ns1__VedioPlayResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__VedioPlayResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__VedioPlayResponse*)p->ptr);
		break;
	case SOAP_TYPE___ns1__writeObjectOut:
		if (p->size < 0)
	...
	case SOAP_TYPE___ns1__VedioPlay:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__VedioPlay*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__VedioPlay*)p->ptr);
		break;
	case SOAP_TYPE___ns1__writeObjectOut_:
		if (p->size < 0)
	...
	case SOAP_TYPE___ns1__VedioPlay_:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__VedioPlay_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__VedioPlay_*)p->ptr);
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
void _ns1__VedioPlayResponse::soap_default(struct soap *soap)
{
	this->soap = soap;
	this->_ns1__VedioPlayResponse::VedioPlayResult = NULL;
	/* transient soap skipped */
}

void _ns1__VedioPlayResponse::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__VedioPlayResponse::VedioPlayResult);
	/* transient soap skipped */
#endif
}

int _ns1__VedioPlayResponse::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__VedioPlayResponse(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__VedioPlayResponse(struct soap *soap, const char *tag, int id, const _ns1__VedioPlayResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__VedioPlayResponse), type))
		return soap->error;
	if (a->VedioPlayResult)
		soap_element_result(soap, "ns1:VedioPlayResult");
	if (soap_out_PointerTostd__wstring(soap, "ns1:VedioPlayResult", -1, &(a->_ns1__VedioPlayResponse::VedioPlayResult), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}

void *_ns1__VedioPlayResponse::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__VedioPlayResponse(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__VedioPlayResponse * SOAP_FMAC4 soap_in__ns1__VedioPlayResponse(struct soap *soap, const char *tag, _ns1__VedioPlayResponse *a, const char *type)
{
	(void)tag; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__VedioPlayResponse *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__VedioPlayResponse, sizeof(_ns1__VedioPlayResponse), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE__ns1__VedioPlayResponse)
		{	soap_revert(soap);
			*soap->id = '\0';
			return (_ns1__VedioPlayResponse *)a->soap_in(soap, tag, type);
		}
	}
	size_t soap_flag_VedioPlayResult1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_VedioPlayResult1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:VedioPlayResult", &(a->_ns1__VedioPlayResponse::VedioPlayResult), "xsd:string"))
				{	soap_flag_VedioPlayResult1--;
					continue;
				}
			/* transient soap skipped */
			soap_check_result(soap, "ns1:VedioPlayResult");
	...
	{	a = (_ns1__VedioPlayResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__VedioPlayResponse, 0, sizeof(_ns1__VedioPlayResponse), 0, soap_copy__ns1__VedioPlayResponse);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
int _ns1__VedioPlayResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, SOAP_TYPE__ns1__VedioPlayResponse);
	if (this->soap_out(soap, tag?tag:"ns1:VedioPlayResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__VedioPlayResponse::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__VedioPlayResponse(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__VedioPlayResponse * SOAP_FMAC4 soap_get__ns1__VedioPlayResponse(struct soap *soap, _ns1__VedioPlayResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__VedioPlayResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 _ns1__VedioPlayResponse * SOAP_FMAC2 soap_instantiate__ns1__VedioPlayResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__VedioPlayResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE__ns1__VedioPlayResponse, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__VedioPlayResponse);
		if (size)
			*size = sizeof(_ns1__VedioPlayResponse);
		((_ns1__VedioPlayResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__VedioPlayResponse, n);
		if (size)
			*size = n * sizeof(_ns1__VedioPlayResponse);
		if (cp->ptr)
			for (int i = 0; i < n; i++)
				((_ns1__VedioPlayResponse*)cp->ptr)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (_ns1__VedioPlayResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__VedioPlayResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying _ns1__VedioPlayResponse %p -> %p\n", q, p));
	*(_ns1__VedioPlayResponse*)p = *(_ns1__VedioPlayResponse*)q;
}

void _ns1__VedioPlay::soap_default(struct soap *soap)
{
	this->soap = soap;
	this->_ns1__VedioPlay::jylsh = NULL;
	this->_ns1__VedioPlay::jyjgbh = NULL;
	this->_ns1__VedioPlay::jkxlh = NULL;
	/* transient soap skipped */
}

void _ns1__VedioPlay::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__VedioPlay::jylsh);
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__VedioPlay::jyjgbh);
	soap_serialize_PointerTostd__wstring(soap, &this->_ns1__VedioPlay::jkxlh);
	/* transient soap skipped */
#endif
}

int _ns1__VedioPlay::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__VedioPlay(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__VedioPlay(struct soap *soap, const char *tag, int id, const _ns1__VedioPlay *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__VedioPlay), type))
		return soap->error;
	if (soap_out_PointerTostd__wstring(soap, "ns1:jylsh", -1, &(a->_ns1__VedioPlay::jylsh), ""))
		return soap->error;
	if (soap_out_PointerTostd__wstring(soap, "ns1:jyjgbh", -1, &(a->_ns1__VedioPlay::jyjgbh), ""))
		return soap->error;
	if (soap_out_PointerTostd__wstring(soap, "ns1:jkxlh", -1, &(a->_ns1__VedioPlay::jkxlh), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}

void *_ns1__VedioPlay::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__VedioPlay(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__VedioPlay * SOAP_FMAC4 soap_in__ns1__VedioPlay(struct soap *soap, const char *tag, _ns1__VedioPlay *a, const char *type)
{
	(void)tag; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__VedioPlay *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__VedioPlay, sizeof(_ns1__VedioPlay), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE__ns1__VedioPlay)
		{	soap_revert(soap);
			*soap->id = '\0';
			return (_ns1__VedioPlay *)a->soap_in(soap, tag, type);
		}
	}
	size_t soap_flag_jylsh1 = 1;
	size_t soap_flag_jyjgbh1 = 1;
	size_t soap_flag_jkxlh1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_jylsh1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:jylsh", &(a->_ns1__VedioPlay::jylsh), "xsd:string"))
				{	soap_flag_jylsh1--;
					continue;
				}
			if (soap_flag_jyjgbh1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:jyjgbh", &(a->_ns1__VedioPlay::jyjgbh), "xsd:string"))
				{	soap_flag_jyjgbh1--;
					continue;
				}
			if (soap_flag_jkxlh1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__wstring(soap, "ns1:jkxlh", &(a->_ns1__VedioPlay::jkxlh), "xsd:string"))
				{	soap_flag_jkxlh1--;
					continue;
				}
			/* transient soap skipped */
	...
	{	a = (_ns1__VedioPlay *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__VedioPlay, 0, sizeof(_ns1__VedioPlay), 0, soap_copy__ns1__VedioPlay);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
int _ns1__VedioPlay::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, SOAP_TYPE__ns1__VedioPlay);
	if (this->soap_out(soap, tag?tag:"ns1:VedioPlay", id, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__VedioPlay::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__VedioPlay(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__VedioPlay * SOAP_FMAC4 soap_get__ns1__VedioPlay(struct soap *soap, _ns1__VedioPlay *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__VedioPlay(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 _ns1__VedioPlay * SOAP_FMAC2 soap_instantiate__ns1__VedioPlay(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__VedioPlay(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE__ns1__VedioPlay, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__VedioPlay);
		if (size)
			*size = sizeof(_ns1__VedioPlay);
		((_ns1__VedioPlay*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__VedioPlay, n);
		if (size)
			*size = n * sizeof(_ns1__VedioPlay);
		if (cp->ptr)
			for (int i = 0; i < n; i++)
				((_ns1__VedioPlay*)cp->ptr)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (_ns1__VedioPlay*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__VedioPlay(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying _ns1__VedioPlay %p -> %p\n", q, p));
	*(_ns1__VedioPlay*)p = *(_ns1__VedioPlay*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__VedioPlay_(struct soap *soap, struct __ns1__VedioPlay_ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__VedioPlay = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__VedioPlay_(struct soap *soap, const struct __ns1__VedioPlay_ *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTo_ns1__VedioPlay(soap, &a->ns1__VedioPlay);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__VedioPlay_(struct soap *soap, const char *tag, int id, const struct __ns1__VedioPlay_ *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_PointerTo_ns1__VedioPlay(soap, "ns1:VedioPlay", -1, &a->ns1__VedioPlay, ""))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__VedioPlay_ * SOAP_FMAC4 soap_in___ns1__VedioPlay_(struct soap *soap, const char *tag, struct __ns1__VedioPlay_ *a, const char *type)
{
	size_t soap_flag_ns1__VedioPlay = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __ns1__VedioPlay_ *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__VedioPlay_, sizeof(struct __ns1__VedioPlay_), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__VedioPlay_(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__VedioPlay && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__VedioPlay(soap, "ns1:VedioPlay", &a->ns1__VedioPlay, ""))
				{	soap_flag_ns1__VedioPlay--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_flag)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__VedioPlay_(struct soap *soap, const struct __ns1__VedioPlay_ *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__VedioPlay_(soap, tag?tag:"-ns1:VedioPlay", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__VedioPlay_ * SOAP_FMAC4 soap_get___ns1__VedioPlay_(struct soap *soap, struct __ns1__VedioPlay_ *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__VedioPlay_(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__VedioPlay_ * SOAP_FMAC2 soap_instantiate___ns1__VedioPlay_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__VedioPlay_(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__VedioPlay_, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__VedioPlay_);
		if (size)
			*size = sizeof(struct __ns1__VedioPlay_);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__VedioPlay_, n);
		if (size)
			*size = n * sizeof(struct __ns1__VedioPlay_);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__VedioPlay_*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__VedioPlay_(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__VedioPlay_ %p -> %p\n", q, p));
	*(struct __ns1__VedioPlay_*)p = *(struct __ns1__VedioPlay_*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__VedioPlay(struct soap *soap, struct __ns1__VedioPlay *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__VedioPlay = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__VedioPlay(struct soap *soap, const struct __ns1__VedioPlay *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTo_ns1__VedioPlay(soap, &a->ns1__VedioPlay);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__VedioPlay(struct soap *soap, const char *tag, int id, const struct __ns1__VedioPlay *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_PointerTo_ns1__VedioPlay(soap, "ns1:VedioPlay", -1, &a->ns1__VedioPlay, ""))
		return soap->error;
...
SOAP_FMAC3 struct __ns1__VedioPlay * SOAP_FMAC4 soap_in___ns1__VedioPlay(struct soap *soap, const char *tag, struct __ns1__VedioPlay *a, const char *type)
{
	size_t soap_flag_ns1__VedioPlay = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __ns1__VedioPlay *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__VedioPlay, sizeof(struct __ns1__VedioPlay), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__VedioPlay(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__VedioPlay && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__VedioPlay(soap, "ns1:VedioPlay", &a->ns1__VedioPlay, ""))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__VedioPlay(struct soap *soap, const struct __ns1__VedioPlay *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__VedioPlay(soap, tag?tag:"-ns1:VedioPlay", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__VedioPlay * SOAP_FMAC4 soap_get___ns1__VedioPlay(struct soap *soap, struct __ns1__VedioPlay *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__VedioPlay(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__VedioPlay * SOAP_FMAC2 soap_instantiate___ns1__VedioPlay(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__VedioPlay(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__VedioPlay, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__VedioPlay);
		if (size)
			*size = sizeof(struct __ns1__VedioPlay);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__VedioPlay, n);
		if (size)
			*size = n * sizeof(struct __ns1__VedioPlay);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__VedioPlay*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__VedioPlay(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__VedioPlay %p -> %p\n", q, p));
	*(struct __ns1__VedioPlay*)p = *(struct __ns1__VedioPlay*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__VedioPlay(struct soap *soap, _ns1__VedioPlay *const*a)
{
#ifndef WITH_NOIDREF
	if (!soap_reference(soap, *a, SOAP_TYPE__ns1__VedioPlay))
		(*a)->soap_serialize(soap);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__VedioPlay(struct soap *soap, const char *tag, int id, _ns1__VedioPlay *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE__ns1__VedioPlay);
	if (id < 0)
		return soap->error;
	return (*a)->soap_out(soap, tag, id, type);
}

SOAP_FMAC3 _ns1__VedioPlay ** SOAP_FMAC4 soap_in_PointerTo_ns1__VedioPlay(struct soap *soap, const char *tag, _ns1__VedioPlay **a, const char *type)
{
	(void)type; /* appease -Wall -Werror */
	...
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
		if (!(a = (_ns1__VedioPlay **)soap_malloc(soap, sizeof(_ns1__VedioPlay *))))
			return NULL;
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = (_ns1__VedioPlay *)soap_instantiate__ns1__VedioPlay(soap, -1, soap->type, soap->arrayType, NULL)))
			return NULL;
		(*a)->soap_default(soap);
	...
	{	_ns1__VedioPlay ** p = (_ns1__VedioPlay **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__VedioPlay, sizeof(_ns1__VedioPlay), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__VedioPlay(struct soap *soap, _ns1__VedioPlay *const*a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerTo_ns1__VedioPlay);
	if (soap_out_PointerTo_ns1__VedioPlay(soap, tag?tag:"ns1:VedioPlay", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 _ns1__VedioPlay ** SOAP_FMAC4 soap_get_PointerTo_ns1__VedioPlay(struct soap *soap, _ns1__VedioPlay **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTo_ns1__VedioPlay(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
