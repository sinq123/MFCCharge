...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__VedioPlayResponse(struct soap*, const char*, int, const _ns1__VedioPlayResponse *, const char*);
SOAP_FMAC3 _ns1__VedioPlayResponse * SOAP_FMAC4 soap_in__ns1__VedioPlayResponse(struct soap*, const char*, _ns1__VedioPlayResponse *, const char*);

#ifndef soap_write__ns1__VedioPlayResponse
#define soap_write__ns1__VedioPlayResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap),0) || (data)->soap_put(soap, "ns1:VedioPlayResponse", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _ns1__VedioPlayResponse * SOAP_FMAC4 soap_get__ns1__VedioPlayResponse(struct soap*, _ns1__VedioPlayResponse *, const char*, const char*);

#ifndef soap_read__ns1__VedioPlayResponse
#define soap_read__ns1__VedioPlayResponse(soap, data) ( soap_begin_recv(soap) || !soap_get__ns1__VedioPlayResponse(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 _ns1__VedioPlayResponse * SOAP_FMAC2 soap_instantiate__ns1__VedioPlayResponse(struct soap*, int, const char*, const char*, size_t*);

inline _ns1__VedioPlayResponse * soap_new__ns1__VedioPlayResponse(struct soap *soap, int n = -1) { return soap_instantiate__ns1__VedioPlayResponse(soap, n, NULL, NULL, NULL); }

inline _ns1__VedioPlayResponse * soap_new_req__ns1__VedioPlayResponse(struct soap *soap) { _ns1__VedioPlayResponse *_p = soap_instantiate__ns1__VedioPlayResponse(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _ns1__VedioPlayResponse * soap_new_set__ns1__VedioPlayResponse(struct soap *soap, std::wstring *VedioPlayResult) { _ns1__VedioPlayResponse *_p = soap_instantiate__ns1__VedioPlayResponse(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_ns1__VedioPlayResponse::VedioPlayResult = VedioPlayResult; } return _p; }

inline void soap_delete__ns1__VedioPlayResponse(struct soap *soap, _ns1__VedioPlayResponse *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__VedioPlayResponse(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__ns1__VedioPlay
#define SOAP_TYPE__ns1__VedioPlay (12)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__VedioPlay(struct soap*, const char*, int, const _ns1__VedioPlay *, const char*);
SOAP_FMAC3 _ns1__VedioPlay * SOAP_FMAC4 soap_in__ns1__VedioPlay(struct soap*, const char*, _ns1__VedioPlay *, const char*);

#ifndef soap_write__ns1__VedioPlay
#define soap_write__ns1__VedioPlay(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap),0) || (data)->soap_put(soap, "ns1:VedioPlay", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _ns1__VedioPlay * SOAP_FMAC4 soap_get__ns1__VedioPlay(struct soap*, _ns1__VedioPlay *, const char*, const char*);

#ifndef soap_read__ns1__VedioPlay
#define soap_read__ns1__VedioPlay(soap, data) ( soap_begin_recv(soap) || !soap_get__ns1__VedioPlay(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 _ns1__VedioPlay * SOAP_FMAC2 soap_instantiate__ns1__VedioPlay(struct soap*, int, const char*, const char*, size_t*);

inline _ns1__VedioPlay * soap_new__ns1__VedioPlay(struct soap *soap, int n = -1) { return soap_instantiate__ns1__VedioPlay(soap, n, NULL, NULL, NULL); }

inline _ns1__VedioPlay * soap_new_req__ns1__VedioPlay(struct soap *soap) { _ns1__VedioPlay *_p = soap_instantiate__ns1__VedioPlay(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _ns1__VedioPlay * soap_new_set__ns1__VedioPlay(struct soap *soap, std::wstring *jylsh, std::wstring *jyjgbh, std::wstring *jkxlh) { _ns1__VedioPlay *_p = soap_instantiate__ns1__VedioPlay(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_ns1__VedioPlay::jylsh = jylsh; _p->_ns1__VedioPlay::jyjgbh = jyjgbh; _p->_ns1__VedioPlay::jkxlh = jkxlh; } return _p; }

inline void soap_delete__ns1__VedioPlay(struct soap *soap, _ns1__VedioPlay *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__VedioPlay(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__VedioPlay_(struct soap*, struct __ns1__VedioPlay_ *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__VedioPlay_(struct soap*, const struct __ns1__VedioPlay_ *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__VedioPlay_(struct soap*, const char*, int, const struct __ns1__VedioPlay_ *, const char*);
SOAP_FMAC3 struct __ns1__VedioPlay_ * SOAP_FMAC4 soap_in___ns1__VedioPlay_(struct soap*, const char*, struct __ns1__VedioPlay_ *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__VedioPlay_(struct soap*, const struct __ns1__VedioPlay_ *, const char*, const char*);

#ifndef soap_write___ns1__VedioPlay_
#define soap_write___ns1__VedioPlay_(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___ns1__VedioPlay_(soap, data),0) || soap_put___ns1__VedioPlay_(soap, data, "-ns1:VedioPlay", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __ns1__VedioPlay_ * SOAP_FMAC4 soap_get___ns1__VedioPlay_(struct soap*, struct __ns1__VedioPlay_ *, const char*, const char*);

#ifndef soap_read___ns1__VedioPlay_
#define soap_read___ns1__VedioPlay_(soap, data) ( soap_begin_recv(soap) || !soap_get___ns1__VedioPlay_(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct __ns1__VedioPlay_ * SOAP_FMAC2 soap_instantiate___ns1__VedioPlay_(struct soap*, int, const char*, const char*, size_t*);

inline struct __ns1__VedioPlay_ * soap_new___ns1__VedioPlay_(struct soap *soap, int n = -1) { return soap_instantiate___ns1__VedioPlay_(soap, n, NULL, NULL, NULL); }

inline struct __ns1__VedioPlay_ * soap_new_req___ns1__VedioPlay_(struct soap *soap) { struct __ns1__VedioPlay_ *_p = soap_instantiate___ns1__VedioPlay_(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__VedioPlay_(soap, _p); } return _p; }

inline struct __ns1__VedioPlay_ * soap_new_set___ns1__VedioPlay_(struct soap *soap, _ns1__VedioPlay *ns1__VedioPlay) { struct __ns1__VedioPlay_ *_p = soap_instantiate___ns1__VedioPlay_(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__VedioPlay_(soap, _p); _p->ns1__VedioPlay = ns1__VedioPlay; } return _p; }

inline void soap_delete___ns1__VedioPlay_(struct soap *soap, struct __ns1__VedioPlay_ *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__VedioPlay_(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__VedioPlay(struct soap*, struct __ns1__VedioPlay *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__VedioPlay(struct soap*, const struct __ns1__VedioPlay *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__VedioPlay(struct soap*, const char*, int, const struct __ns1__VedioPlay *, const char*);
SOAP_FMAC3 struct __ns1__VedioPlay * SOAP_FMAC4 soap_in___ns1__VedioPlay(struct soap*, const char*, struct __ns1__VedioPlay *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__VedioPlay(struct soap*, const struct __ns1__VedioPlay *, const char*, const char*);

#ifndef soap_write___ns1__VedioPlay
#define soap_write___ns1__VedioPlay(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___ns1__VedioPlay(soap, data),0) || soap_put___ns1__VedioPlay(soap, data, "-ns1:VedioPlay", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __ns1__VedioPlay * SOAP_FMAC4 soap_get___ns1__VedioPlay(struct soap*, struct __ns1__VedioPlay *, const char*, const char*);

#ifndef soap_read___ns1__VedioPlay
#define soap_read___ns1__VedioPlay(soap, data) ( soap_begin_recv(soap) || !soap_get___ns1__VedioPlay(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct __ns1__VedioPlay * SOAP_FMAC2 soap_instantiate___ns1__VedioPlay(struct soap*, int, const char*, const char*, size_t*);

inline struct __ns1__VedioPlay * soap_new___ns1__VedioPlay(struct soap *soap, int n = -1) { return soap_instantiate___ns1__VedioPlay(soap, n, NULL, NULL, NULL); }

inline struct __ns1__VedioPlay * soap_new_req___ns1__VedioPlay(struct soap *soap) { struct __ns1__VedioPlay *_p = soap_instantiate___ns1__VedioPlay(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__VedioPlay(soap, _p); } return _p; }

inline struct __ns1__VedioPlay * soap_new_set___ns1__VedioPlay(struct soap *soap, _ns1__VedioPlay *ns1__VedioPlay) { struct __ns1__VedioPlay *_p = soap_instantiate___ns1__VedioPlay(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__VedioPlay(soap, _p); _p->ns1__VedioPlay = ns1__VedioPlay; } return _p; }

inline void soap_delete___ns1__VedioPlay(struct soap *soap, struct __ns1__VedioPlay *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__VedioPlay(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#ifndef SOAP_TYPE_PointerTo_ns1__VedioPlay
#define SOAP_TYPE_PointerTo_ns1__VedioPlay (25)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__VedioPlay(struct soap*, _ns1__VedioPlay *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__VedioPlay(struct soap*, const char *, int, _ns1__VedioPlay *const*, const char *);
SOAP_FMAC3 _ns1__VedioPlay ** SOAP_FMAC4 soap_in_PointerTo_ns1__VedioPlay(struct soap*, const char*, _ns1__VedioPlay **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__VedioPlay(struct soap*, _ns1__VedioPlay *const*, const char*, const char*);

#ifndef soap_write_PointerTo_ns1__VedioPlay
#define soap_write_PointerTo_ns1__VedioPlay(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_PointerTo_ns1__VedioPlay(soap, data),0) || soap_put_PointerTo_ns1__VedioPlay(soap, data, "ns1:VedioPlay", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _ns1__VedioPlay ** SOAP_FMAC4 soap_get_PointerTo_ns1__VedioPlay(struct soap*, _ns1__VedioPlay **, const char*, const char*);

#ifndef soap_read_PointerTo_ns1__VedioPlay
#define soap_read_PointerTo_ns1__VedioPlay(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_ns1__VedioPlay(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef SOAP_TYPE_PointerTo_ns1__queryObjectOut
#define SOAP_TYPE_PointerTo_ns1__queryObjectOut (21)
#endif
...
#define SOAP_TYPE_PointerTo_ns1__writeObjectOut (17)
#endif
