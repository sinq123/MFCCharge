...
void CALLBACK MessDataCallBackFunc(LONG lCommand, LPNET_CALLBACK_DATA lpData, DWORD dwUser)
{
	CNVDSDKDemoDlg *dlg = (CNVDSDKDemoDlg *)dwUser;
...
void CALLBACK DecPlayBackPosFunc(LONG lLoginID, int nEncoderID, DWORD dwTotalSize, DWORD dwPlaySize, DWORD dwUser)
{
	CNVDSDKDemoDlg *dlg = (CNVDSDKDemoDlg *)dwUser;
	if (dlg == NULL)
	{
...
void CNVDSDKDemoDlg::DecPlayBackPosCallback(LONG lLoginID, int nEncoderID, DWORD dwTotalSize, DWORD dwPlaySize, DWORD dwUser)
{
...
void CNVDSDKDemoDlg::DevDisConnect(LONG lLoginID, char *pchDVRIP, LONG nDVRPort)
{
	{
		CReadWriteMutexLock lock(m_csDevice);
...
void CNVDSDKDemoDlg::DevHaveReconnect(LONG lLoginID, char *pchDVRIP, LONG nDVRPort)
{
	{
		CReadWriteMutexLock lock(m_csDevice);
