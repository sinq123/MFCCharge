...
public:
	...
	void DevHaveReconnect(LONG lLoginID, char *pchDVRIP, LONG nDVRPort);
	void DevDisConnect(LONG lLoginID, char *pchDVRIP, LONG nDVRPort);
	void UpdateDeviceList();
	void UpdateDecoderList();
	void MessDataCallBack(LONG lCommand, LPNET_CALLBACK_DATA lpData);
	void DecPlayBackPosCallback(LONG lLoginID, int nEncoderID, DWORD dwTotalSize, DWORD dwPlaySize, DWORD dwUser);
