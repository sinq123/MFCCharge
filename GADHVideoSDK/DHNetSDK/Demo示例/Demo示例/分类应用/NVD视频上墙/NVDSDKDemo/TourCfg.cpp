...
{
	int ctlIndex = m_ctlManufactory.AddString("大华");
	m_ctlManufactory.SetItemData(ctlIndex,DH_IPC_PRIVATE);
	ctlIndex = m_ctlManufactory.AddString("美电贝尔");
	m_ctlManufactory.SetItemData(ctlIndex,DH_IPC_AEBELL);
	ctlIndex = m_ctlManufactory.AddString("松下");
	m_ctlManufactory.SetItemData(ctlIndex,DH_IPC_PANASONIC);
	ctlIndex = m_ctlManufactory.AddString("索尼");
	...
	ctlIndex = m_ctlManufactory.AddString("天城威视");
	m_ctlManufactory.SetItemData(ctlIndex,DH_IPC_TCWS);
	ctlIndex = m_ctlManufactory.AddString("三星");
	...
	ctlIndex = m_ctlManufactory.AddString("安讯视");
	m_ctlManufactory.SetItemData(ctlIndex,DH_IPC_AXIS);
	ctlIndex = m_ctlManufactory.AddString("三洋");
	...
	ctlIndex = m_ctlManufactory.AddString("动力盈科");
	...
	ctlIndex = m_ctlManufactory.AddString("Onvif协议类型");
	m_ctlManufactory.SetItemData(ctlIndex,DH_IPC_ONVIF);
	ctlIndex = m_ctlManufactory.AddString("视霸");
	m_ctlManufactory.SetItemData(ctlIndex,DH_IPC_SHEPHERD);
	ctlIndex = m_ctlManufactory.AddString("亚安");
	...
	ctlIndex = m_ctlManufactory.AddString("讯美");
	m_ctlManufactory.SetItemData(ctlIndex,DH_IPC_XUNMEI);
	ctlIndex = m_ctlManufactory.AddString("海康");
	...
	ctlIndex = m_ctlManufactory.AddString("奥奇曼");
	m_ctlManufactory.SetItemData(ctlIndex,DH_IPC_AOQIMAN);
	ctlIndex = m_ctlManufactory.AddString("宝康");
	...
	ctlIndex = m_ctlManufactory.AddString("富士通");
...
bool CTourCfg::ChangeManuFactoryToStr(UINT dwType, char *pOutBuf, UINT nOutBufLen)
{
	...
	{
	case DH_IPC_PRIVATE:
		memcpy(pOutBuf, "大华", sizeof("大华"));
		break;
	case DH_IPC_AEBELL:
		memcpy(pOutBuf, "美电贝尔", sizeof("美电贝尔"));
		break;
	case DH_IPC_PANASONIC:
		memcpy(pOutBuf, "松下", sizeof("松下"));
		break;
	case DH_IPC_SONY:
		memcpy(pOutBuf, "索尼", sizeof("索尼"));
		break;
	case DH_IPC_DYNACOLOR:
		memcpy(pOutBuf, "Dynacolor", sizeof("Dynacolor"));
		break;
	case DH_IPC_TCWS:
		memcpy(pOutBuf, "天城威视", sizeof("天城威视"));
		break;
	case DH_IPC_SAMSUNG:
		memcpy(pOutBuf, "三星", sizeof("三星"));
		break;
	case DH_IPC_YOKO:
		memcpy(pOutBuf, "YOKO", sizeof("YOKO"));
		break;
	case DH_IPC_AXIS:
		memcpy(pOutBuf, "安讯视", sizeof("安讯视"));
		break;
	case DH_IPC_SANYO:
		memcpy(pOutBuf, "三洋", sizeof("三洋"));
		break;
	case DH_IPC_BOSH:
	...
	case DH_IPC_VIDEOTREC:
		memcpy(pOutBuf, "动力盈科", sizeof("动力盈科"));
		break;
	case DH_IPC_URA:
	...
	case DH_IPC_BITICINO:
		...
		break;
	case DH_IPC_ONVIF:
		memcpy(pOutBuf, "Onvif协议类型", sizeof("Onvif协议类型"));
		break;
	case DH_IPC_SHEPHERD:
		memcpy(pOutBuf, "视霸", sizeof("视霸"));
		break;
	case DH_IPC_YAAN:
		memcpy(pOutBuf, "亚安", sizeof("亚安"));
		break;
	...
	case DH_IPC_TYCO:
		...
		break;
	case DH_IPC_XUNMEI:
		memcpy(pOutBuf, "讯美", sizeof("讯美"));
		break;
	case DH_IPC_HIKVISION:
		memcpy(pOutBuf, "海康", sizeof("海康"));
		break;
	case DH_IPC_LG:
		memcpy(pOutBuf, "LG", sizeof("LG"));
		break;
	case DH_IPC_AOQIMAN:
		memcpy(pOutBuf, "奥奇曼", sizeof("奥奇曼"));
		break;
	case DH_IPC_BAOKANG:
		memcpy(pOutBuf, "宝康", sizeof("宝康"));
		break;
