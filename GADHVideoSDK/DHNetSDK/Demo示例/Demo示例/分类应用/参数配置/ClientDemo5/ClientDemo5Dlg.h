...
public:
	...
	void SetNetWorkConfigInfo(DHDEV_NET_CFG *pNetIOInfo, DHDEV_MAIL_CFG *pMailInfo, CFG_MULTICASTS_INFO_IN* pMulticastIn);
	...
	void SetFTPConfigInfo(FTP_PROTO_CFG_EX* pstFTPConfigInfo, int nChannelId = 0);
	void GetFTPConfigInfo(FTP_PROTO_CFG_EX* pstFTPConfigInfo, int nChannelId = 0);
	void GetFTPInfo();
	...
	void GetOneChannelDspConfig(DHDEV_DSP_ENCODECAP &stDspInfo, int nCurChannel, CFG_DSPENCODECAP_INFO &stDspEncodeCapInfo, BOOL& bShowPix);
