...
private:
	...
	int m_nCurrentTimePeriod;
	
//	CFG_NAS_INFO_EX m_stuNasInfoEx;

	void ShowConfigInfo(void);
	void ShowCurrentChannelInfo(void);
	void ShowCurrentTimePeriod(int nChannel);
	void SaveCurrentChannelInfo(int nChannel);
	void SaveCurrentTimePeriod(int nChannel, int nTimePeriod);
