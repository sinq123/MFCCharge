...
protected:
	...
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
	static int  __stdcall RealLoadPicCallback (LONG lAnalyzerHandle, DWORD dwAlarmType, void* pAlarmInfo, BYTE *pBuffer, DWORD dwBufSize, DWORD dwUser, int nSequence, void *userdata);
...
public:
	...
	void OnDisConnect(LONG lLoginID, char *pchDVRIP, LONG nDVRPort, DWORD dwUser);
