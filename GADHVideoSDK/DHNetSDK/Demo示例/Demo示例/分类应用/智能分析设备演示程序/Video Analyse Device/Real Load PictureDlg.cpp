...
BOOL CRealLoadPictureDlg::OnInitDialog()
{
	...
	/*                                                                      */
	/************************************************************************/
	SetDlgItemText(IDC_IPADDRESS_IP, "192.168.1.2");
	...
	/*                                                                      */
	/************************************************************************/
	CLIENT_Init(CRealLoadPictureDlg::OnDisConnect, (DWORD)this);
...
void CRealLoadPictureDlg::OnDisConnect(LONG lLoginID, char *pchDVRIP, LONG nDVRPort, DWORD dwUser)
{
