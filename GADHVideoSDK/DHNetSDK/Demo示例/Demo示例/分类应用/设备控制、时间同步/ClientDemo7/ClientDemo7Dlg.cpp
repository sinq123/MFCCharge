...
void CClientDemo7Dlg::DeviceDisConnect(LONG lLoginID, char *sDVRIP, LONG nDVRPort)
{
...
void CClientDemo7Dlg::OnButtonSet()
{
	...
	if(bValid && (0 != m_LoginID))
	{
		...
		//Set time 
		bSuccess = CLIENT_SetDevConfig(m_LoginID,DH_DEV_TIMECFG,-1,&curDateTime,sizeof(NET_TIME));
		if(bSuccess)
		{
...
void CClientDemo7Dlg::OnButtonGet() 
{
	...
	if(0 != m_LoginID)
	{
		...
		BOOL bSuccess = CLIENT_GetDevConfig(m_LoginID,DH_DEV_TIMECFG,
			-1,&curDateTime,sizeof(NET_TIME),&dwRet);
...
void CClientDemo7Dlg::OnButtonRestart() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_CTRL_REBOOT,NULL);
		if(bSuccess)
		{
...
void CClientDemo7Dlg::GetDiskInfo()
{
	if( 0 != m_LoginID)
	{
		...
		BOOL bSuccess = CLIENT_QueryDevState(m_LoginID,DH_DEVSTATE_DISK,(char *)&diskInfo,
			sizeof(DH_HARDDISK_STATE),&nRetLen);
...
void CClientDemo7Dlg::OnButtonAlarmstart() 
{
	...
	if(0 != m_LoginID)
	{
		...
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_TRIGGER_ALARM_IN,&alarmParam);
		if(bSuccess)
		{
			GetDlgItem(IDC_BUTTON_ALARMSTART)->EnableWindow(FALSE);
...
void CClientDemo7Dlg::OnButtonOutalarmstart() 
{
	...
	if(0 != m_LoginID)
	{
		...
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_TRIGGER_ALARM_OUT,&alarmParam);
		if(bSuccess)
		{
			GetDlgItem(IDC_BUTTON_OUTALARMSTART)->EnableWindow(FALSE);
...
void CClientDemo7Dlg::OnButtonNum0() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN0,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum1() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN1,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum2() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN2,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum3() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN3,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum4() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN4,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum5() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN5,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum6() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN6,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum7() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN7,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum8() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN8,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum9() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN9,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum10() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN10,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum11() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN11,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum12() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN12,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum13() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN13,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"),ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum14() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN14,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum15() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN15,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNum16() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_BTN16,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonRec() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_REC,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonPrew() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_PREW,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonSlow() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_SLOW,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonPlay() 
{
	...
	if(0 != m_LoginID)
	{
		...
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_PLAY,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonFast() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_FAST,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNext() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_NEXT,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonStop() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_STOP,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonJmpup() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_JMPUP,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonJmpdown() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_JMPDOWN,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonEsc() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_ESC,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonFn1() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_FN1,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonFn2() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_FN2,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonUp() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_UP,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonDown() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_DOWN,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonLeft() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_LEFT,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonRight() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_RIGHT,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonEnter() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_ENTER,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonNine() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_NINE,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonOne() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_ONE,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonInfo() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_INFO,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonAddr() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_ADDR,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonSplit() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_SPLIT,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
...
void CClientDemo7Dlg::OnButtonPower() 
{
	...
	if(0 != m_LoginID)
	{
		BOOL bSuccess = CLIENT_ControlDevice(m_LoginID,DH_KEYBOARD_POWER,NULL);
		if(!bSuccess)
		{
			MessageBox(ConvertString("Control failed!"), ConvertString("Prompt"));
		}
