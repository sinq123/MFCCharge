 ...
 * Date: 2006.12
	purpose:	Function interface definition and illustration for user 2nd development 
*********************************************************************/
#ifndef _DHPLAY_H
#define _DHPLAY_H
...
#define  FUNC_MAX_PORT 100              //Max play channel amount
//Wave coef range;
...
#define SUPPORT_BLT         2  //Display card supports BLT operation£»otherwise player does not work.
...
typedef struct{
	...
	long nType;   //Data type£¬T_AUDIO16£¬T_RGB32£¬ T_YV12.Please refer to macro illustration
...
PLAYSDK_API BOOL CALLMETHOD PLAY_OneByOne(LONG nPort);//Network frame by frame callback
