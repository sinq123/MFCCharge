#if !defined(AFX_DHEXTPTZCTRL_H__12D9C4FD_3019_49AA_8567_5444C8AE6CF0__INCLUDED_)
#define AFX_DHEXTPTZCTRL_H__12D9C4FD_3019_49AA_8567_5444C8AE6CF0__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DHExtPtzCtrl.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CDHExtPtzCtrl dialog

class CDHExtPtzCtrl : public CDialog
{
	LONG m_DeviceID ;
	DWORD m_Channel ;
// Construction
public:
	CDHExtPtzCtrl(CWnd* pParent = NULL);   // standard constructor
	void SetExtPtzParam(LONG iHandle, int iChannel);
	void PtzExtControl(DWORD dwCommand, DWORD dwParam = 0);

// Dialog Data
	//{{AFX_DATA(CDHExtPtzCtrl)
...
#endif // !defined(AFX_DHEXTPTZCTRL_H__12D9C4FD_3019_49AA_8567_5444C8AE6CF0__INCLUDED_)
