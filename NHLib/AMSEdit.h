...
#define AMSEDIT_EXPORT	AFX_EXT_CLASS
...
#define AMSEDIT_COMPILED_CLASSES	AMSEDIT_DATE_CLASS
...
public:
	...
	public:
		...
		public:
				...
				typedef int (*ValidationFunction)(unsigned short);		
...
#define AMS_MAX_OLEDATETIME		COleDateTime(2100, 12, 31, 23, 59, 59)
