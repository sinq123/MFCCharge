...
*   作者:Cui
*	描述:1.改变以下地方,使支持中文路径
*			1.1将vector<char> filename_改为vector<wchar_t> filename_;
*			1.2修改函数:bool Block::Create(const wchar_t* filename)
*			1.3修改函数:bool Block::Open(const wchar_t* filename, ios_base::openmode mode)
*			1.4添加函数:bool SaveAs(const wchar_t* filename);
*        2.内部很多ANSI函数依然有问题,请尽量使用UNICODE函数
*/
...
protected:
	//////////////////////////////////////////////////////////////modify by Cui 2009-09-04(begin)
	vector<wchar_t> filename_;
	//////////////////////////////////////////////////////////////modify by Cui 2009-09-04(end)
...
class AFX_EXT_CLASS CompoundFile
{
public:
...
protected:
	...
	class AFX_EXT_CLASS PropertyTree
	{
	public:
		PropertyTree();
		~PropertyTree();
...
class AFX_EXT_CLASS BasicExcel;
class AFX_EXT_CLASS BasicExcelWorksheet;
class AFX_EXT_CLASS BasicExcelCell;
