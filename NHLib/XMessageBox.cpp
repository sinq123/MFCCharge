...
struct CXDialogTemplate::ButtonInfo CXDialogTemplate::g_ButtonText[] =		
{
	...
	IDS_CANCEL,           _T("取消"),
	IDS_CONTINUE,         _T("&继续"),
	IDS_DONOTASKAGAIN,    _T("下次不再询问。"),
	IDS_DONOTTELLAGAIN,   _T("下次不再通知。"),
	IDS_DONOTSHOWAGAIN,   _T("下次不再显示。"),
	IDS_HELP,             _T("&帮助"),
	IDS_IGNORE,           _T("&忽略"),
	IDS_IGNOREALL,        _T("全部忽略"),
	IDS_NO,               _T("&否"),
	IDS_NOTOALL,          _T("全部选否"),
	IDS_OK,               _T("确定"),
	IDS_REPORT,           _T("报告"),
	...
	IDS_SKIP,             _T("&跳过"),
	IDS_SKIPALL,          _T("全部跳过"),
	IDS_TRYAGAIN,         _T("&再试一次"),
	IDS_YES,              _T("&是"),
	IDS_YESTOALL,         _T("全部选是")
};
				...
				XMSGBOXPARAMS * pXMB /*= NULL*/)
{
	...
	if ((nStyle & MB_ICONHAND) && (nStyle & MB_SYSTEMMODAL))
	{
		...
		return ::MessageBoxEx(hwnd, lpszMessage, lpszCaption, nStyle, LANG_CHINESE_SIMPLIFIED);
	}
