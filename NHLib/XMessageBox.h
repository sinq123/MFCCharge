...
int AFX_EXT_API XMessageBox(HWND hwnd, 
				LPCTSTR lpszMessage,
...
DWORD AFX_EXT_API XMessageBoxGetCheckBox(LPCTSTR lpszCompanyName, LPCTSTR lpszModule, int nLine);

DWORD AFX_EXT_API XMessageBoxGetCheckBox(XMSGBOXPARAMS& xmb);
