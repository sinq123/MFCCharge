...
class CNHModeServerDBService
{
public:
	CNHModeServerDBService(void);
	virtual ~CNHModeServerDBService(void);

private:
	// 禁用拷贝构造函数和拷贝赋值函数
	CNHModeServerDBService(const CNHModeServerDBService &);
	CNHModeServerDBService & operator =(const CNHModeServerDBService &);
