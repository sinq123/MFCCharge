...
BEGIN_MESSAGE_MAP(CPDAOnLineApp, CWinApp)
...
// 唯一的一个 CPDAOnLineApp 对象

CPDAOnLineApp theApp;


// CPDAOnLineApp 初始化

BOOL CPDAOnLineApp::InitInstance()
{
