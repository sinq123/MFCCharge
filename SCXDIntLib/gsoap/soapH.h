...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__URLDecodeResponse(struct soap*, const char*, int, const _ns1__URLDecodeResponse *, const char*);
SOAP_FMAC3 _ns1__URLDecodeResponse * SOAP_FMAC4 soap_in__ns1__URLDecodeResponse(struct soap*, const char*, _ns1__URLDecodeResponse *, const char*);

#ifndef soap_write__ns1__URLDecodeResponse
#define soap_write__ns1__URLDecodeResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap),0) || (data)->soap_put(soap, "ns1:URLDecodeResponse", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _ns1__URLDecodeResponse * SOAP_FMAC4 soap_get__ns1__URLDecodeResponse(struct soap*, _ns1__URLDecodeResponse *, const char*, const char*);

#ifndef soap_read__ns1__URLDecodeResponse
#define soap_read__ns1__URLDecodeResponse(soap, data) ( soap_begin_recv(soap) || !soap_get__ns1__URLDecodeResponse(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 _ns1__URLDecodeResponse * SOAP_FMAC2 soap_instantiate__ns1__URLDecodeResponse(struct soap*, int, const char*, const char*, size_t*);

inline _ns1__URLDecodeResponse * soap_new__ns1__URLDecodeResponse(struct soap *soap, int n = -1) { return soap_instantiate__ns1__URLDecodeResponse(soap, n, NULL, NULL, NULL); }

inline _ns1__URLDecodeResponse * soap_new_req__ns1__URLDecodeResponse(struct soap *soap) { _ns1__URLDecodeResponse *_p = soap_instantiate__ns1__URLDecodeResponse(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _ns1__URLDecodeResponse * soap_new_set__ns1__URLDecodeResponse(struct soap *soap, std::wstring *URLDecodeResult) { _ns1__URLDecodeResponse *_p = soap_instantiate__ns1__URLDecodeResponse(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_ns1__URLDecodeResponse::URLDecodeResult = URLDecodeResult; } return _p; }

inline void soap_delete__ns1__URLDecodeResponse(struct soap *soap, _ns1__URLDecodeResponse *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__URLDecodeResponse(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__ns1__URLDecode
#define SOAP_TYPE__ns1__URLDecode (14)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__URLDecode(struct soap*, const char*, int, const _ns1__URLDecode *, const char*);
SOAP_FMAC3 _ns1__URLDecode * SOAP_FMAC4 soap_in__ns1__URLDecode(struct soap*, const char*, _ns1__URLDecode *, const char*);

#ifndef soap_write__ns1__URLDecode
#define soap_write__ns1__URLDecode(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap),0) || (data)->soap_put(soap, "ns1:URLDecode", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _ns1__URLDecode * SOAP_FMAC4 soap_get__ns1__URLDecode(struct soap*, _ns1__URLDecode *, const char*, const char*);

#ifndef soap_read__ns1__URLDecode
#define soap_read__ns1__URLDecode(soap, data) ( soap_begin_recv(soap) || !soap_get__ns1__URLDecode(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 _ns1__URLDecode * SOAP_FMAC2 soap_instantiate__ns1__URLDecode(struct soap*, int, const char*, const char*, size_t*);

inline _ns1__URLDecode * soap_new__ns1__URLDecode(struct soap *soap, int n = -1) { return soap_instantiate__ns1__URLDecode(soap, n, NULL, NULL, NULL); }

inline _ns1__URLDecode * soap_new_req__ns1__URLDecode(struct soap *soap) { _ns1__URLDecode *_p = soap_instantiate__ns1__URLDecode(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _ns1__URLDecode * soap_new_set__ns1__URLDecode(struct soap *soap, std::wstring *xtlb, std::wstring *jkxlh, std::wstring *data) { _ns1__URLDecode *_p = soap_instantiate__ns1__URLDecode(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_ns1__URLDecode::xtlb = xtlb; _p->_ns1__URLDecode::jkxlh = jkxlh; _p->_ns1__URLDecode::data = data; } return _p; }

inline void soap_delete__ns1__URLDecode(struct soap *soap, _ns1__URLDecode *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__URLDecode(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__ns1__URLEncodeResponse
#define SOAP_TYPE__ns1__URLEncodeResponse (13)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__URLEncodeResponse(struct soap*, const char*, int, const _ns1__URLEncodeResponse *, const char*);
SOAP_FMAC3 _ns1__URLEncodeResponse * SOAP_FMAC4 soap_in__ns1__URLEncodeResponse(struct soap*, const char*, _ns1__URLEncodeResponse *, const char*);

#ifndef soap_write__ns1__URLEncodeResponse
#define soap_write__ns1__URLEncodeResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap),0) || (data)->soap_put(soap, "ns1:URLEncodeResponse", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _ns1__URLEncodeResponse * SOAP_FMAC4 soap_get__ns1__URLEncodeResponse(struct soap*, _ns1__URLEncodeResponse *, const char*, const char*);

#ifndef soap_read__ns1__URLEncodeResponse
#define soap_read__ns1__URLEncodeResponse(soap, data) ( soap_begin_recv(soap) || !soap_get__ns1__URLEncodeResponse(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 _ns1__URLEncodeResponse * SOAP_FMAC2 soap_instantiate__ns1__URLEncodeResponse(struct soap*, int, const char*, const char*, size_t*);

inline _ns1__URLEncodeResponse * soap_new__ns1__URLEncodeResponse(struct soap *soap, int n = -1) { return soap_instantiate__ns1__URLEncodeResponse(soap, n, NULL, NULL, NULL); }

inline _ns1__URLEncodeResponse * soap_new_req__ns1__URLEncodeResponse(struct soap *soap) { _ns1__URLEncodeResponse *_p = soap_instantiate__ns1__URLEncodeResponse(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _ns1__URLEncodeResponse * soap_new_set__ns1__URLEncodeResponse(struct soap *soap, std::wstring *URLEncodeResult) { _ns1__URLEncodeResponse *_p = soap_instantiate__ns1__URLEncodeResponse(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_ns1__URLEncodeResponse::URLEncodeResult = URLEncodeResult; } return _p; }

inline void soap_delete__ns1__URLEncodeResponse(struct soap *soap, _ns1__URLEncodeResponse *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__URLEncodeResponse(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__ns1__URLEncode
#define SOAP_TYPE__ns1__URLEncode (12)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__URLEncode(struct soap*, const char*, int, const _ns1__URLEncode *, const char*);
SOAP_FMAC3 _ns1__URLEncode * SOAP_FMAC4 soap_in__ns1__URLEncode(struct soap*, const char*, _ns1__URLEncode *, const char*);

#ifndef soap_write__ns1__URLEncode
#define soap_write__ns1__URLEncode(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap),0) || (data)->soap_put(soap, "ns1:URLEncode", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _ns1__URLEncode * SOAP_FMAC4 soap_get__ns1__URLEncode(struct soap*, _ns1__URLEncode *, const char*, const char*);

#ifndef soap_read__ns1__URLEncode
#define soap_read__ns1__URLEncode(soap, data) ( soap_begin_recv(soap) || !soap_get__ns1__URLEncode(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 _ns1__URLEncode * SOAP_FMAC2 soap_instantiate__ns1__URLEncode(struct soap*, int, const char*, const char*, size_t*);

inline _ns1__URLEncode * soap_new__ns1__URLEncode(struct soap *soap, int n = -1) { return soap_instantiate__ns1__URLEncode(soap, n, NULL, NULL, NULL); }

inline _ns1__URLEncode * soap_new_req__ns1__URLEncode(struct soap *soap) { _ns1__URLEncode *_p = soap_instantiate__ns1__URLEncode(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _ns1__URLEncode * soap_new_set__ns1__URLEncode(struct soap *soap, std::wstring *xtlb, std::wstring *jkxlh, std::wstring *data) { _ns1__URLEncode *_p = soap_instantiate__ns1__URLEncode(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_ns1__URLEncode::xtlb = xtlb; _p->_ns1__URLEncode::jkxlh = jkxlh; _p->_ns1__URLEncode::data = data; } return _p; }

inline void soap_delete__ns1__URLEncode(struct soap *soap, _ns1__URLEncode *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__URLEncode(struct soap*, int, int, void*, size_t, const void*, size_t);
...
inline _ns1__writeObjectOut * soap_new_set__ns1__writeObjectOut(struct soap *soap, std::wstring *xtlb, std::wstring *jkxlh, std::wstring *jkid, std::wstring *xmlDoc) { _ns1__writeObjectOut *_p = soap_instantiate__ns1__writeObjectOut(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_ns1__writeObjectOut::xtlb = xtlb; _p->_ns1__writeObjectOut::jkxlh = jkxlh; _p->_ns1__writeObjectOut::jkid = jkid; _p->_ns1__writeObjectOut::xmlDoc = xmlDoc; } return _p; }
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__URLDecode_(struct soap*, struct __ns1__URLDecode_ *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__URLDecode_(struct soap*, const struct __ns1__URLDecode_ *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__URLDecode_(struct soap*, const char*, int, const struct __ns1__URLDecode_ *, const char*);
SOAP_FMAC3 struct __ns1__URLDecode_ * SOAP_FMAC4 soap_in___ns1__URLDecode_(struct soap*, const char*, struct __ns1__URLDecode_ *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__URLDecode_(struct soap*, const struct __ns1__URLDecode_ *, const char*, const char*);

#ifndef soap_write___ns1__URLDecode_
#define soap_write___ns1__URLDecode_(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___ns1__URLDecode_(soap, data),0) || soap_put___ns1__URLDecode_(soap, data, "-ns1:URLDecode", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __ns1__URLDecode_ * SOAP_FMAC4 soap_get___ns1__URLDecode_(struct soap*, struct __ns1__URLDecode_ *, const char*, const char*);

#ifndef soap_read___ns1__URLDecode_
#define soap_read___ns1__URLDecode_(soap, data) ( soap_begin_recv(soap) || !soap_get___ns1__URLDecode_(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct __ns1__URLDecode_ * SOAP_FMAC2 soap_instantiate___ns1__URLDecode_(struct soap*, int, const char*, const char*, size_t*);

inline struct __ns1__URLDecode_ * soap_new___ns1__URLDecode_(struct soap *soap, int n = -1) { return soap_instantiate___ns1__URLDecode_(soap, n, NULL, NULL, NULL); }

inline struct __ns1__URLDecode_ * soap_new_req___ns1__URLDecode_(struct soap *soap) { struct __ns1__URLDecode_ *_p = soap_instantiate___ns1__URLDecode_(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__URLDecode_(soap, _p); } return _p; }

inline struct __ns1__URLDecode_ * soap_new_set___ns1__URLDecode_(struct soap *soap, _ns1__URLDecode *ns1__URLDecode) { struct __ns1__URLDecode_ *_p = soap_instantiate___ns1__URLDecode_(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__URLDecode_(soap, _p); _p->ns1__URLDecode = ns1__URLDecode; } return _p; }

inline void soap_delete___ns1__URLDecode_(struct soap *soap, struct __ns1__URLDecode_ *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__URLDecode_(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE___ns1__URLEncode_
#define SOAP_TYPE___ns1__URLEncode_ (40)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__URLEncode_(struct soap*, struct __ns1__URLEncode_ *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__URLEncode_(struct soap*, const struct __ns1__URLEncode_ *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__URLEncode_(struct soap*, const char*, int, const struct __ns1__URLEncode_ *, const char*);
SOAP_FMAC3 struct __ns1__URLEncode_ * SOAP_FMAC4 soap_in___ns1__URLEncode_(struct soap*, const char*, struct __ns1__URLEncode_ *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__URLEncode_(struct soap*, const struct __ns1__URLEncode_ *, const char*, const char*);

#ifndef soap_write___ns1__URLEncode_
#define soap_write___ns1__URLEncode_(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___ns1__URLEncode_(soap, data),0) || soap_put___ns1__URLEncode_(soap, data, "-ns1:URLEncode", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __ns1__URLEncode_ * SOAP_FMAC4 soap_get___ns1__URLEncode_(struct soap*, struct __ns1__URLEncode_ *, const char*, const char*);

#ifndef soap_read___ns1__URLEncode_
#define soap_read___ns1__URLEncode_(soap, data) ( soap_begin_recv(soap) || !soap_get___ns1__URLEncode_(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct __ns1__URLEncode_ * SOAP_FMAC2 soap_instantiate___ns1__URLEncode_(struct soap*, int, const char*, const char*, size_t*);

inline struct __ns1__URLEncode_ * soap_new___ns1__URLEncode_(struct soap *soap, int n = -1) { return soap_instantiate___ns1__URLEncode_(soap, n, NULL, NULL, NULL); }

inline struct __ns1__URLEncode_ * soap_new_req___ns1__URLEncode_(struct soap *soap) { struct __ns1__URLEncode_ *_p = soap_instantiate___ns1__URLEncode_(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__URLEncode_(soap, _p); } return _p; }

inline struct __ns1__URLEncode_ * soap_new_set___ns1__URLEncode_(struct soap *soap, _ns1__URLEncode *ns1__URLEncode) { struct __ns1__URLEncode_ *_p = soap_instantiate___ns1__URLEncode_(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__URLEncode_(soap, _p); _p->ns1__URLEncode = ns1__URLEncode; } return _p; }

inline void soap_delete___ns1__URLEncode_(struct soap *soap, struct __ns1__URLEncode_ *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__URLEncode_(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__URLDecode(struct soap*, struct __ns1__URLDecode *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__URLDecode(struct soap*, const struct __ns1__URLDecode *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__URLDecode(struct soap*, const char*, int, const struct __ns1__URLDecode *, const char*);
SOAP_FMAC3 struct __ns1__URLDecode * SOAP_FMAC4 soap_in___ns1__URLDecode(struct soap*, const char*, struct __ns1__URLDecode *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__URLDecode(struct soap*, const struct __ns1__URLDecode *, const char*, const char*);

#ifndef soap_write___ns1__URLDecode
#define soap_write___ns1__URLDecode(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___ns1__URLDecode(soap, data),0) || soap_put___ns1__URLDecode(soap, data, "-ns1:URLDecode", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __ns1__URLDecode * SOAP_FMAC4 soap_get___ns1__URLDecode(struct soap*, struct __ns1__URLDecode *, const char*, const char*);

#ifndef soap_read___ns1__URLDecode
#define soap_read___ns1__URLDecode(soap, data) ( soap_begin_recv(soap) || !soap_get___ns1__URLDecode(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct __ns1__URLDecode * SOAP_FMAC2 soap_instantiate___ns1__URLDecode(struct soap*, int, const char*, const char*, size_t*);

inline struct __ns1__URLDecode * soap_new___ns1__URLDecode(struct soap *soap, int n = -1) { return soap_instantiate___ns1__URLDecode(soap, n, NULL, NULL, NULL); }

inline struct __ns1__URLDecode * soap_new_req___ns1__URLDecode(struct soap *soap) { struct __ns1__URLDecode *_p = soap_instantiate___ns1__URLDecode(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__URLDecode(soap, _p); } return _p; }

inline struct __ns1__URLDecode * soap_new_set___ns1__URLDecode(struct soap *soap, _ns1__URLDecode *ns1__URLDecode) { struct __ns1__URLDecode *_p = soap_instantiate___ns1__URLDecode(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__URLDecode(soap, _p); _p->ns1__URLDecode = ns1__URLDecode; } return _p; }

inline void soap_delete___ns1__URLDecode(struct soap *soap, struct __ns1__URLDecode *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__URLDecode(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE___ns1__URLEncode
#define SOAP_TYPE___ns1__URLEncode (30)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__URLEncode(struct soap*, struct __ns1__URLEncode *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__URLEncode(struct soap*, const struct __ns1__URLEncode *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__URLEncode(struct soap*, const char*, int, const struct __ns1__URLEncode *, const char*);
SOAP_FMAC3 struct __ns1__URLEncode * SOAP_FMAC4 soap_in___ns1__URLEncode(struct soap*, const char*, struct __ns1__URLEncode *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__URLEncode(struct soap*, const struct __ns1__URLEncode *, const char*, const char*);

#ifndef soap_write___ns1__URLEncode
#define soap_write___ns1__URLEncode(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___ns1__URLEncode(soap, data),0) || soap_put___ns1__URLEncode(soap, data, "-ns1:URLEncode", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __ns1__URLEncode * SOAP_FMAC4 soap_get___ns1__URLEncode(struct soap*, struct __ns1__URLEncode *, const char*, const char*);

#ifndef soap_read___ns1__URLEncode
#define soap_read___ns1__URLEncode(soap, data) ( soap_begin_recv(soap) || !soap_get___ns1__URLEncode(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct __ns1__URLEncode * SOAP_FMAC2 soap_instantiate___ns1__URLEncode(struct soap*, int, const char*, const char*, size_t*);

inline struct __ns1__URLEncode * soap_new___ns1__URLEncode(struct soap *soap, int n = -1) { return soap_instantiate___ns1__URLEncode(soap, n, NULL, NULL, NULL); }

inline struct __ns1__URLEncode * soap_new_req___ns1__URLEncode(struct soap *soap) { struct __ns1__URLEncode *_p = soap_instantiate___ns1__URLEncode(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__URLEncode(soap, _p); } return _p; }

inline struct __ns1__URLEncode * soap_new_set___ns1__URLEncode(struct soap *soap, _ns1__URLEncode *ns1__URLEncode) { struct __ns1__URLEncode *_p = soap_instantiate___ns1__URLEncode(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___ns1__URLEncode(soap, _p); _p->ns1__URLEncode = ns1__URLEncode; } return _p; }

inline void soap_delete___ns1__URLEncode(struct soap *soap, struct __ns1__URLEncode *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__URLEncode(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#ifndef SOAP_TYPE_PointerTo_ns1__URLDecode
#define SOAP_TYPE_PointerTo_ns1__URLDecode (31)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__URLDecode(struct soap*, _ns1__URLDecode *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__URLDecode(struct soap*, const char *, int, _ns1__URLDecode *const*, const char *);
SOAP_FMAC3 _ns1__URLDecode ** SOAP_FMAC4 soap_in_PointerTo_ns1__URLDecode(struct soap*, const char*, _ns1__URLDecode **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__URLDecode(struct soap*, _ns1__URLDecode *const*, const char*, const char*);

#ifndef soap_write_PointerTo_ns1__URLDecode
#define soap_write_PointerTo_ns1__URLDecode(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_PointerTo_ns1__URLDecode(soap, data),0) || soap_put_PointerTo_ns1__URLDecode(soap, data, "ns1:URLDecode", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _ns1__URLDecode ** SOAP_FMAC4 soap_get_PointerTo_ns1__URLDecode(struct soap*, _ns1__URLDecode **, const char*, const char*);

#ifndef soap_read_PointerTo_ns1__URLDecode
#define soap_read_PointerTo_ns1__URLDecode(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_ns1__URLDecode(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef SOAP_TYPE_PointerTo_ns1__URLEncode
#define SOAP_TYPE_PointerTo_ns1__URLEncode (27)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__URLEncode(struct soap*, _ns1__URLEncode *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__URLEncode(struct soap*, const char *, int, _ns1__URLEncode *const*, const char *);
SOAP_FMAC3 _ns1__URLEncode ** SOAP_FMAC4 soap_in_PointerTo_ns1__URLEncode(struct soap*, const char*, _ns1__URLEncode **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__URLEncode(struct soap*, _ns1__URLEncode *const*, const char*, const char*);

#ifndef soap_write_PointerTo_ns1__URLEncode
#define soap_write_PointerTo_ns1__URLEncode(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_PointerTo_ns1__URLEncode(soap, data),0) || soap_put_PointerTo_ns1__URLEncode(soap, data, "ns1:URLEncode", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _ns1__URLEncode ** SOAP_FMAC4 soap_get_PointerTo_ns1__URLEncode(struct soap*, _ns1__URLEncode **, const char*, const char*);

#ifndef soap_read_PointerTo_ns1__URLEncode
#define soap_read_PointerTo_ns1__URLEncode(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_ns1__URLEncode(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef SOAP_TYPE_PointerTo_ns1__queryObjectOut
#define SOAP_TYPE_PointerTo_ns1__queryObjectOut (23)
#endif
